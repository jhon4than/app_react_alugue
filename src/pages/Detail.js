 ...
 return (
   <View style={styles.container}>
    ...
    <Text style={styles.description}>
     Aqui você encontra os melhores carros de luxo, com os melhores preço da cidade.
    </Text>

    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35 }}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/carro5.jpg')}
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/carro6.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/carro2.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
    </ScrollView>
